...
class FavoritePageTableViewCell:UITableViewCell{
...
class FavoritePageViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func update(){
        shareData()
        load()
        let offset:Int = Int(searchData[3])!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let offset:Int = Int(searchData[3])!
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell") as! FavoritePageTableViewCell
