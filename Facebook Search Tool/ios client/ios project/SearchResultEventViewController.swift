//
//  SearchResultEventViewController.swift
//  Homework9
//
...
class SearchResultEventTableViewCell: UITableViewCell{
...
class SearchResultEventViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func startSearching(){
        ...
        shareData()
        phpURL = "http://sample-env-1.nwnpppmvdn.us-west-2.elasticbeanstalk.com/index.php/search.php?keyword=\(searchData[0])&offset=\(searchData[4])&version=hw9&type=\(searchData[1])"
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell") as! SearchResultEventTableViewCell
        //set Image
    ...
    @IBAction func clickPrevious(_ sender: Any) {
        var offset:Int = Int(searchData[4])!
        offset -= 10
        searchData[4] = "\(offset)"
        startSearching()
    }
