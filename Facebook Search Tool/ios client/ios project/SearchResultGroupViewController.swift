//
//  SearchResultGroupViewController.swift
//  Homework9
//
...
class SearchResultGroupTableViewCell: UITableViewCell{
    @IBOutlet weak var cellLabel: UILabel!
    @IBOutlet weak var cellImage: UIImageView!
    @IBOutlet weak var cellFavorite: UIImageView!
}

class SearchResultGroupViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func startSearching(){
        ...
        shareData()
        phpURL = "http://sample-env-1.nwnpppmvdn.us-west-2.elasticbeanstalk.com/index.php/search.php?keyword=\(searchData[0])&offset=\(searchData[6])&version=hw9&type=\(searchData[1])"
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell") as! SearchResultGroupTableViewCell
        //set Image
