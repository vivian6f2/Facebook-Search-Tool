//
//  SearchResultPlaceViewController.swift
//  Homework9
//
...
class SearchResultPlaceTableViewCell: UITableViewCell{
    @IBOutlet weak var cellLabel: UILabel!
    @IBOutlet weak var cellImage: UIImageView!
    @IBOutlet weak var cellFavorite: UIImageView!
}

class SearchResultPlaceViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func startSearching(){
        ...
        shareData()
        if(lat != "" && lon != ""){
            phpURL = "http://sample-env-1.nwnpppmvdn.us-west-2.elasticbeanstalk.com/index.php/search.php?keyword=\(searchData[0])&offset=\(searchData[5])&version=hw9&type=\(searchData[1])&latitude=\(lat)&longitude=\(lon)"
        }else{
            phpURL = "http://sample-env-1.nwnpppmvdn.us-west-2.elasticbeanstalk.com/index.php/search.php?keyword=\(searchData[0])&offset=\(searchData[5])&version=hw9&type=\(searchData[1])"
        }
        //print(phpURL)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell") as! SearchResultPlaceTableViewCell
        //set Image
    ...
    @IBAction func clickPrevious(_ sender: Any) {
        var offset:Int = Int(searchData[5])!
        offset -= 10
        searchData[5] = "\(offset)"
        startSearching()
    }
