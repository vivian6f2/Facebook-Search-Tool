...
class SearchResultPageTableViewCell: UITableViewCell{
...
class SearchResultPageViewController: UIViewController, UITableViewDataSource, UITableViewDelegate  {
    ...
    func startSearching(){
        ...
        shareData()
        phpURL = "http://sample-env-1.nwnpppmvdn.us-west-2.elasticbeanstalk.com/index.php/search.php?keyword=\(searchData[0])&offset=\(searchData[3])&version=hw9&type=\(searchData[1])"
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell") as! SearchResultPageTableViewCell
        //set Image
    ...
    @IBAction func clickPrevious(_ sender: Any) {
        var offset:Int = Int(searchData[3])!
        offset -= 10
        searchData[3] = "\(offset)"
        startSearching()
    }
