...
class FavoritePlaceViewController: UIViewController, UITableViewDataSource ,UITableViewDelegate{
    ...
    func update(){
        shareData()
        load()
        let offset:Int = Int(searchData[5])!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let offset:Int = Int(searchData[5])!
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell") as! FavoritePlaceTableViewCell
